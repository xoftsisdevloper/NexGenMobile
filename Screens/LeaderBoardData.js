...
const LeaderboardSummary = () => {
    ...
    return (
        <ScrollView contentContainerStyle={{ flexGrow: 1, backgroundColor: colorPalette.aliceBlue, padding: 20 }}>
            {/* Test Switch Buttons */}
                                    ...
                                    <FlatList
                                        ...
                                        renderItem={({ item, index }) => (
                                            <View style={styles.leaderRow}>
                                                <View style={styles.rankInfo}>
                                                    <TrophySVG value={item.rank} size={50} color={visibleColors[index % visibleColors.length]} />
                                                    <Text style={styles.rankText}>{item.user.username} {item.rank}</Text>
                                                </View>
                                                <Text style={styles.rankText}>{item.score}</Text>
                                            </View>
                                        )}
